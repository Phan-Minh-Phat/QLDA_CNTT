...
{
    public class ProvideMaintenanceServiceModel : PageModel
    {
        private readonly IProjectService _projectService;
        private readonly IServiceService _serviceService;
        private readonly IMaintenanceResultService _maintenanceResultService;

        public ProvideMaintenanceServiceModel(
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            TempData["SuccessMessage"] = "Dịch vụ bảo dưỡng đã được cung cấp thành công!";
